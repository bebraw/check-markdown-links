...
if(require.main === module) {
  ...
  if(!directory) {
    return console.error('Missing entry directory!');
  }

  checkMarkdownLinks(directory);
}
else {
  module.exports = checkMarkdownLinks;
}

function checkMarkdownLinks(directory) {
  getLinks(directory, function(err, urls) {
    if(err) {
